...
if(!isset($user)) {
    ...
    redirect_to('forgot_password.php'); //where is this? 
}
...
<div class="container">
    <div class="jumbotron border shadow">
        ...
        <form id="userPasswordReset" class="needs-validation" novalidate action="<?php echo $url; ?>" method="POST" accept-charset="utf-8">
