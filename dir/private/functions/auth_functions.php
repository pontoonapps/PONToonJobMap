...
function log_in_admin($admin)
{
    ...
    $_SESSION['admin_first_name'] = $admin['first_name']; //take value for admin first name and store in the session
    $_SESSION['admin_last_name'] = $admin['last_name']; //take value for admin last name and store in the session
    $_SESSION['admin_email'] = $admin['email']; //take value for admin email and store in the session
    return true;
}
